                    ...
                    <div class="pd u-s-m-b-30">
                        <div class="pd-wrap">
                            <div id="pd-o-initiate" class="slick-initialized slick-slider">
                                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 2225px;"><div class="pd-o-img-wrap slick-slide slick-current slick-active" data-src="images/product/product-d-1.jpg" data-slick-index="0" aria-hidden="false" style="width: 445px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" tabindex="0">

                                    <img class="u-img-fluid" src="images/product/product-d-1.jpg" data-zoom-image="images/product/product-d-1.jpg" alt=""></div><div class="pd-o-img-wrap slick-slide" data-src="images/product/product-d-2.jpg" data-slick-index="1" aria-hidden="true" style="width: 445px; position: relative; left: -445px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">

                                    <img class="u-img-fluid" src="images/product/product-d-2.jpg" data-zoom-image="images/product/product-d-2.jpg" alt=""></div><div class="pd-o-img-wrap slick-slide" data-src="images/product/product-d-3.jpg" data-slick-index="2" aria-hidden="true" style="width: 445px; position: relative; left: -890px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">

                                    <img class="u-img-fluid" src="images/product/product-d-3.jpg" data-zoom-image="images/product/product-d-3.jpg" alt=""></div><div class="pd-o-img-wrap slick-slide" data-src="images/product/product-d-4.jpg" data-slick-index="3" aria-hidden="true" style="width: 445px; position: relative; left: -1335px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">

                                    <img class="u-img-fluid" src="images/product/product-d-4.jpg" data-zoom-image="images/product/product-d-4.jpg" alt=""></div><div class="pd-o-img-wrap slick-slide" data-src="images/product/product-d-5.jpg" data-slick-index="4" aria-hidden="true" style="width: 445px; position: relative; left: -1780px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1">

                                    <img class="u-img-fluid" src="images/product/product-d-5.jpg" data-zoom-image="images/product/product-d-5.jpg" alt=""></div></div></div>
                        ...
                        <div class="u-s-m-t-15">
                            <div>
                                <div id="pd-o-thumbnail" class="slick-initialized slick-slider"><div class="pt-prev slick-arrow slick-disabled" aria-disabled="true" ><i class="fas fa-angle-left"></i></div>
                                    <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 560px; transform: translate3d(0px, 0px, 0px);"><div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 112px;" tabindex="0">

                                        <img class="u-img-fluid" src="images/product/product-d-1.jpg" alt=""></div><div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 112px;" tabindex="0">

                                        <img class="u-img-fluid" src="images/product/product-d-2.jpg" alt=""></div><div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" style="width: 112px;" tabindex="0">

                                        <img class="u-img-fluid" src="images/product/product-d-3.jpg" alt=""></div><div class="slick-slide slick-active" data-slick-index="3" aria-hidden="false" style="width: 112px;" tabindex="0">

                                        <img class="u-img-fluid" src="images/product/product-d-4.jpg" alt=""></div><div class="slick-slide" data-slick-index="4" aria-hidden="true" style="width: 112px;" tabindex="-1">

                                        <img class="u-img-fluid" src="images/product/product-d-5.jpg" alt=""></div></div></div>




                                <div class="pt-next slick-arrow"  aria-disabled="false"><i class="fas fa-angle-right"></i></div></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="pd-desc">
                                <div class="pd-tab__desc">
                                    ...
                                    <div class="u-s-m-b-30"><div class="fluid-width-video-wrapper"><iframe src="https://www.youtube.com/embed/qKqSBm07KZk" allowfullscreen="" name="fitvid0"></iframe></div></div>
                                    <div class="u-s-m-b-30">
                                        <ul>
        ...
        <div class="section__content">
            <div class="container">
                <div>
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1665px;"><div class="owl-item active" style="width: 277.5px;"><div class="u-s-m-b-30">
