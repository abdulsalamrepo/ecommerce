                        ...
                        <div class="card-body">
                            <a href="{{route('admin.products')}}">
                                < Back to List</a>
                                    ...
                                    <br>
                                    <img id="imageHolder" src="{{asset($product->image_name)}}" alt="" height="300" width="300"/>
                                    <br>
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                       ...
                                       <input id="inp_img" name="img" type="hidden" value="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control" id="weight"  name="weight" value="{{$product->weight}}">
                                        </div>
                                        <div class="form-group ">
